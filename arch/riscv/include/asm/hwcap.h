...
#define RISCV_ISA_EXT_ZICCLSM		111
#define RISCV_ISA_EXT_ZICCAMOA		112
#define RISCV_ISA_EXT_ZICCIF		113
#define RISCV_ISA_EXT_ZA64RS		114
#define RISCV_ISA_EXT_ZIC64B		115
#define RISCV_ISA_EXT_SSQOSID		116
